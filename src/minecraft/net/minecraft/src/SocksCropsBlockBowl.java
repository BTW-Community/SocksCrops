...
public class SocksCropsBlockBowl extends Block {
    private final FCModelBlock blockModel = new SocksCropsModelBlockBowl();
    
	protected SocksCropsBlockBowl(int ID) {
		...
		this.setUnlocalizedName("SocksCropsBlockBowl");
		this.InitBlockBounds(0.25, 0, 0.25, 0.75, 0.25, 0.75);
	}
    ...
    public AxisAlignedBB GetBlockBoundsFromPool(IBlockAccess Access, int x, int y, int z) {
		return AxisAlignedBB.getAABBPool().getAABB(0, 0, 0, 1, ((SocksCropsModelBlockBowl) this.blockModel).blockHeight, 1);
    }
    ...
    public void registerIcons(IconRegister register) {
    	icon_top = register.registerIcon("wood_spruce");
    	icon_bottom = register.registerIcon("wood_spruce");
    	icon_sides_0 = register.registerIcon("wood_spruce");
    	icon_sides_1 = register.registerIcon("wood_spruce");
    }
