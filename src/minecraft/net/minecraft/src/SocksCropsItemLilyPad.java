...
public class SocksCropsItemLilyPad extends Item
{
    public SocksCropsItemLilyPad( int iItemID )
    {
    	super( iItemID);
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        else
        {
            if (var4.typeOfHit == EnumMovingObjectType.TILE)
            {
                ...
                {
                    par2World.setBlock(var5, var6 + 1, var7, SocksCropsDefs.waterlilyPlant.blockID);
