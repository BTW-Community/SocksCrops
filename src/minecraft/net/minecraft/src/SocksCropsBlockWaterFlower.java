...
public class SocksCropsBlockWaterFlower extends SocksCropsBlockWaterPlants
{
    protected SocksCropsBlockWaterFlower(int par1, Material par2Material)
    {
    ...
    protected SocksCropsBlockWaterFlower(int par1)
    {
