...
public class RenderBlocks
{
     ...
     * Render block crops
     */
    public boolean renderRoots(Block par1Block, int par2, int par3, int par4)
    {
        Tessellator var5 = Tessellator.instance;
        var5.setBrightness(par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4));
        var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
        ...
        this.renderRootsImpl(par1Block, this.blockAccess.getBlockMetadata(par2, par3, par4), (double)par2, (double)par3 + var7, (double)par4);
        return true;
    }
    /**
     * Render block crops
     */
    public boolean renderBlockSalad(Block par1Block, int par2, int par3, int par4)
    {
        Tessellator var5 = Tessellator.instance;
        var5.setBrightness(par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4));
        var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
        ...
        this.renderBlockSaladImpl(par1Block, this.blockAccess.getBlockMetadata(par2, par3, par4), (double)par2, (double)par3 + var7, (double)par4, 1.0F);
        this.drawCrossedSquares(par1Block, this.blockAccess.getBlockMetadata(par2, par3, par4), var11, var13, var15, 1.0F);
        return true;
    }
    
    public boolean renderLilyFlower(Block par1Block, int par2, int par3, int par4)
    {
        Tessellator var5 = Tessellator.instance;
        var5.setBrightness(par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4));
        var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
        ...
        this.drawLilyFlower(par1Block, this.blockAccess.getBlockMetadata(par2, par3, par4), var11, var13, var15, 1.0F);
        this.renderBlockCrops(par1Block, par2, par3, par4);
        return true;
    }
    //ADDON
     ...
     */
    public void drawCrossedSquares(Block par1Block, int par2, double x, double y, double z, float par9)
    {
        ...
        double var12 = (double)icon.getMinU();
        double var14 = (double)icon.getMinV();
        double var16 = (double)icon.getMaxU();
        double var18 = (double)icon.getMaxV();
        double angle = 0.45D * (double)par9;
        double xMinusAngle = x + 0.5D - angle;
        double xPlusAngle = x + 0.5D + angle;
        double zMinusAngle = z + 0.5D - angle;
        double zPlusAngle = z + 0.5D + angle;
        tess.addVertexWithUV(xMinusAngle, y + (double)par9, zMinusAngle, var12, var14);
        tess.addVertexWithUV(xMinusAngle, y + 0.0D, zMinusAngle, var12, var18);
        
        tess.addVertexWithUV(xPlusAngle, y + 0.0D, zPlusAngle, var16, var18);
        tess.addVertexWithUV(xPlusAngle, y + (double)par9, zPlusAngle, var16, var14);
        
        tess.addVertexWithUV(xPlusAngle, y + (double)par9, zPlusAngle, var12, var14);
        tess.addVertexWithUV(xPlusAngle, y + 0.0D, zPlusAngle, var12, var18);
        
        tess.addVertexWithUV(xMinusAngle, y + 0.0D, zMinusAngle, var16, var18);
        tess.addVertexWithUV(xMinusAngle, y + (double)par9, zMinusAngle, var16, var14);
        
        tess.addVertexWithUV(xMinusAngle, y + (double)par9, zPlusAngle, var12, var14);
        tess.addVertexWithUV(xMinusAngle, y + 0.0D, zPlusAngle, var12, var18);
        
        tess.addVertexWithUV(xPlusAngle, y + 0.0D, zMinusAngle, var16, var18);
        tess.addVertexWithUV(xPlusAngle, y + (double)par9, zMinusAngle, var16, var14);
        
        tess.addVertexWithUV(xPlusAngle, y + (double)par9, zMinusAngle, var12, var14);
        tess.addVertexWithUV(xPlusAngle, y + 0.0D, zMinusAngle, var12, var18);
        
        tess.addVertexWithUV(xMinusAngle, y + 0.0D, zPlusAngle, var16, var18);
        tess.addVertexWithUV(xMinusAngle, y + (double)par9, zPlusAngle, var16, var14);
    }
     ...
     * Render block crops implementation
     */
    public void renderRootsImpl(Block par1Block, int par2, double par3, double par5, double par7)
    {
        Tessellator var9 = Tessellator.instance;
        Icon var10 = this.getBlockIconFromSideAndMetadata(par1Block, 0, par2);
     ...
     * Render block crops implementation
     */
    public void renderBlockSaladImpl(Block par1Block, int par2, double x, double par5, double z, float par9)
    {
    	Tessellator var9 = Tessellator.instance;
        Icon var10 = this.getBlockIconFromSideAndMetadata(par1Block, 0, par2);
     ...
     * Utility function to draw crossed squares
     */
    public void drawLilyFlower(Block par1Block, int par2, double x, double y, double z, float par9)
    {
        Tessellator tess = Tessellator.instance;
        Icon icon = this.getBlockIconFromSideAndMetadata(par1Block, 0, par2);
        ...
        //X
        tess.addVertexWithUV(xMinusAngle, y + (double)par9, zMinusAngle, minU, minV);
        tess.addVertexWithUV(xMinusAngle, y + 0.0D, zMinusAngle, minU, maxV);
        
        tess.addVertexWithUV(xPlusAngle, y + 0.0D, zPlusAngle, maxU, maxV);
        tess.addVertexWithUV(xPlusAngle, y + (double)par9, zPlusAngle, maxU, minV);
        
        tess.addVertexWithUV(xPlusAngle, y + (double)par9, zPlusAngle, minU, minV);
        tess.addVertexWithUV(xPlusAngle, y + 0.0D, zPlusAngle, minU, maxV);
        
        tess.addVertexWithUV(xMinusAngle, y + 0.0D, zMinusAngle, maxU, maxV);
        tess.addVertexWithUV(xMinusAngle, y + (double)par9, zMinusAngle, maxU, minV);
        

        tess.addVertexWithUV(xMinusAngle, y + (double)par9, zPlusAngle, minU, minV);
        tess.addVertexWithUV(xMinusAngle, y + 0.0D, zPlusAngle, minU, maxV);
        
        tess.addVertexWithUV(xPlusAngle, y + 0.0D, zMinusAngle, maxU, maxV);
        tess.addVertexWithUV(xPlusAngle, y + (double)par9, zMinusAngle, maxU, minV);
        
        tess.addVertexWithUV(xPlusAngle, y + (double)par9, zMinusAngle, minU, minV);
        tess.addVertexWithUV(xPlusAngle, y + 0.0D, zMinusAngle, minU, maxV);
        
        tess.addVertexWithUV(xMinusAngle, y + 0.0D, zPlusAngle, maxU, maxV);
        tess.addVertexWithUV(xMinusAngle, y + (double)par9, zPlusAngle, maxU, minV); 
    }
    //ADDON
