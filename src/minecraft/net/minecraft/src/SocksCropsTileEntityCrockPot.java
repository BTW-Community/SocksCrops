...
public class SocksCropsTileEntityCrockPot extends FCTileEntityCookingVessel
{
	private final int m_iStackSizeLimit = 1;
	public static final int m_iInventorySize = 6;
	private ItemStack[] m_Contents = new ItemStack[6];
    /**
    ...
    public void writeToNBT(NBTTagCompound var1)
    {
        ...
        var1.setInteger("m_iCrockPotCookCounter", this.m_iCookCounter);
    ...
    public void ValidateContentsForState()
    {
        ...
        {
            if (SocksCropsCraftingManagerCrockPot.getInstance().GetCraftingResult(this) != null)
            {
        ...
        else if (this.m_iFireUnderType == 2)
        {
            ...
            else if (SocksCropsCraftingManagerCrockPotStoked.getInstance().GetCraftingResult(this) != null)
            {
                this.m_bContainsValidIngrediantsForState = true;
            }
        }
    ...
    {
        return (FCCraftingManagerBulk)(var1 == 1 ? SocksCropsCraftingManagerCrockPot.getInstance() : (var1 == 2 ? SocksCropsCraftingManagerCrockPotStoked.getInstance() : null));
    }
