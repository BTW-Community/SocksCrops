...
public class SocksCropsClientGuiCookingVessel extends GuiContainer
{
    ...
    public SocksCropsClientGuiCookingVessel(InventoryPlayer var1, FCTileEntityCookingVessel var2, int var3)
    {
    ...
    {
        if (this.m_iContainerID == SocksCropsDefs.socksCropsCrockPotContainerID)
        {
            this.fontRenderer.drawString("Crock Pot", 66, 6, 4210752);
        }
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
    {
        ...
        this.mc.renderEngine.bindTexture("/sockscrops/socksCrockPot.png");
