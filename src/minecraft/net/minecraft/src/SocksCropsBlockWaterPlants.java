...
public abstract class SocksCropsBlockWaterPlants extends Block
{
    protected SocksCropsBlockWaterPlants(int var1, Material var2)
    {
        super(var1, var2);
    }
    ...
    {
        return super.canPlaceBlockAt(var1, var2, var3, var4) && this.CanGrowOnWater(var1, var2, var3 - 1, var4);
    }
    ...
    {
        return this.CanGrowOnWater(var1, var2, var3 - 1, var4);
    }
    ...
    public boolean CanGrowOnWater(World var1, int var2, int var3, int var4)
    {
        return var1.getBlockId(var2, var3, var4) == Block.dirt.blockID;
    }
