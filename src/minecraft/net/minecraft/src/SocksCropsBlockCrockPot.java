...
public class SocksCropsBlockCrockPot extends FCBlockCookingVessel
{
    private Icon m_IconContents;

    public SocksCropsBlockCrockPot(int var1)
    {
        super(var1, Material.iron);
        this.setHardness(3.5F);
        this.setResistance(10.0F);
        this.setStepSound(soundMetalFootstep);
        this.setUnlocalizedName("SocksCropsBlockCrockPot");
    ...
    {
        return new SocksCropsTileEntityCrockPot();
    }
    ...
    protected void ValidateFireUnderState(World var1, int var2, int var3, int var4)
    {
        if (!var1.isRemote)
        {
            ...
            if (var5 instanceof SocksCropsTileEntityCrockPot)
            {
            	SocksCropsTileEntityCrockPot var6 = (SocksCropsTileEntityCrockPot)var5;
    ...
    {
        return SocksCropsDefs.socksCropsCrockPotContainerID;
    }
