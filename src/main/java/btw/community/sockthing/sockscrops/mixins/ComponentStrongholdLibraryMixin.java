...
public abstract class ComponentStrongholdLibraryMixin extends ComponentStronghold {
    ...
    protected ComponentStrongholdLibraryMixin(int par1) {
        super(par1);
    }

    static {
        chestLoot.add(new WeightedRandomChestContent(Item.book.itemID, 0, 1, 3, 20));
        chestLoot.add(new WeightedRandomChestContent(Item.paper.itemID, 0, 2, 7, 20));
        chestLoot.add(new WeightedRandomChestContent(Item.emptyMap.itemID, 0, 1, 1, 1));
        chestLoot.add(new WeightedRandomChestContent(Item.compass.itemID, 0, 1, 1, 1));

        LootHandler.addStrongholdLibraryChestLoot(chestLoot);
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox) {
        if (this.isLiquidInStructureBoundingBox(par1World, par3StructureBoundingBox)) {
            ...
            this.generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 3, 3, 5, WeightedRandomChestContent.func_92080_a(chestLoot.toArray(arr), Item.enchantedBook.func_92112_a(par2Random, 1, 5, 2)), 1 + par2Random.nextInt(4));
//            this.generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 3, 3, 5, WeightedRandomChestContent.func_92080_a(strongholdLibraryChestContents, new WeightedRandomChestContent[] {Item.enchantedBook.func_92112_a(par2Random, 1, 5, 2)}), 1 + par2Random.nextInt(4));
            ...
            if (this.isLargeRoom) {
                ...
                this.generateStructureChestContents(par1World, par3StructureBoundingBox, par2Random, 12, 8, 1, WeightedRandomChestContent.func_92080_a(chestLoot.toArray(arr), Item.enchantedBook.func_92112_a(par2Random, 1, 5, 2)), 1 + par2Random.nextInt(4));
