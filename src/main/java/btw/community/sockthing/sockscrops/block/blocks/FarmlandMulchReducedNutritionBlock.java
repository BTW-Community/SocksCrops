...
public class FarmlandMulchReducedNutritionBlock extends FarmlandReducedNutritionBlock {
    public FarmlandMulchReducedNutritionBlock(int blockID, String name) {
        super(blockID, name);
    }
