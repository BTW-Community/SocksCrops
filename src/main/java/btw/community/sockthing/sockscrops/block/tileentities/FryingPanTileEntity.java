...
public class FryingPanTileEntity extends TileEntity implements TileEntityDataPacketHandler, IInventory
{
    ...
    private void updateCookState()
    {
        if ( cookStack != null )
        {
            ...
            if ( fireLevel >= 2 )
            {
//                SCCraftingManagerPanCookingRecipe recipe = SCCraftingManagerPanCooking.instance.getRecipe( cookStack, null);
//
//                if ( recipe != null )
//                {
//                    cookCounter++;
...
//        {
//            if ( SCCraftingManagerPanCooking.instance.getRecipe( cookStack, null ) != null )
//            {
