...
public class FlowerpotBlock extends BlockContainer {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
        ...
        if (handItemStack == null) {
            potTile.retrieveItemFromPot(player, par6);
            return true;
        }
        ...
        //System.out.println("is Valid: " + potTile.isValidItemForPot(heldID, heldDamage));
...
//        System.out.println("isValid: " + potTile.isValidItemForPot(storedBlockID, storedBlockMetadata));
        ...
        //Renders other blocks as crossed squares. Double checks validity
            ...
            SCRenderUtils.renderCrossedSquares(render, storedBlock, storedBlockMetadata, x, y, z, 0, 4/16F, 0, 0.75F, false);
