...
import btw.community.sockthing.sockscrops.block.models.FryingPanModel;
...
{
    private FryingPanModel pan = new FryingPanModel();
    ...
    public void renderPan(float x, float y, float z, int meta, float rot)
    {
        ...
        this.bindTextureByName("/scmodtex/fryingPan/frying_pan.png");
    ...
    {
        FryingPanTileEntity pan = (FryingPanTileEntity)tileEntity;
    ...
    private void RenderCookStack( FryingPanTileEntity pan, double xCoord, double yCoord, double zCoord, float fPartialTickCount )
    {
