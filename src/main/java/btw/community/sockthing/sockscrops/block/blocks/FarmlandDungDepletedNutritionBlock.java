...
public class FarmlandDungDepletedNutritionBlock extends FarmlandDepletedNutritionBlock {
    public FarmlandDungDepletedNutritionBlock(int blockID, String name) {
        super(blockID, name);
    }
    ...
    protected int getFarmlandOnFullPlantGrowthWhenDunged() {
        return SCBlocks.farmlandDepletedNutrition.blockID;
    }
