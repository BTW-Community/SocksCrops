...
public class FarmlandFertilizedLowNutritionBlock extends FarmlandLowNutritionBlock {
    public FarmlandFertilizedLowNutritionBlock(int blockID, String name) {
        super(blockID, name);
    }
    ...
    public float getNutritionMultiplier() {
        return 2F * NutritionUtils.MULTIPLIER_LOW_NUTRITION;
    }
