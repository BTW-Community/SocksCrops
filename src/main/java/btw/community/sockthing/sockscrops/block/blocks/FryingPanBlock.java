...
import btw.community.sockthing.sockscrops.block.tileentities.FryingPanTileEntity;
...
public class FryingPanBlock extends PrimitiveCookingContainer {
    public FryingPanBlock(int par1, String name)
    {
    ...
    {
        FryingPanTileEntity pan = (FryingPanTileEntity)world.getBlockTileEntity( i, j, k );
...
//    	        }
    ...
    public boolean onBlockActivated( World world, int i, int j, int k, EntityPlayer player, int iFacing, float fXClick, float fYClick, float fZClick )
    {
        ...
        if (pan != null)
        {
            if (heldStack != null)
            {
//                SCCraftingManagerPanCookingRecipe recipe = SCCraftingManagerPanCooking.instance.getRecipe( heldStack, null );
//                if ( cookStack.isItemEqual(recipe.getStackInPan()) && isValidCookItem( heldStack ) )
//                {
...
//                }
    ...
    {
//        if ( SCCraftingManagerPanCooking.instance.getRecipe( stack, null ) != null )
//        {
//            return true;
//        }
    ...
    public boolean rotateAroundJAxis( World world, int i, int j, int k, boolean bReverse )
    {
        ...
        if ( tileEnt != null && tileEnt instanceof FryingPanTileEntity)
        {
            FryingPanTileEntity skullEnt = (FryingPanTileEntity)tileEnt;
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        if (!par1World.isRemote)
        {
            if ((par6 & 8) == 0)
            {
                ...
                FryingPanTileEntity var8 = (FryingPanTileEntity)par1World.getBlockTileEntity(par2, par3, par4);
