...
public class SCBlockPumpkinGrowingWhiteSleeping extends SCBlockPumpkinGrowingWhite {

	protected int awakeFruit;
	
	protected SCBlockPumpkinGrowingWhiteSleeping(int iBlockID, int stemBlock, int vineBlock, int flowerBlock, int convertedBlockID, int awakeFruit) {
