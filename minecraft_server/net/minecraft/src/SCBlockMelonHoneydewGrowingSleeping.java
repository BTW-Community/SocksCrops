...
public class SCBlockMelonHoneydewGrowingSleeping extends SCBlockMelonHoneydewGrowing {
	protected int awakeFruit;
	
	protected SCBlockMelonHoneydewGrowingSleeping(int iBlockID, int stemBlock, int vineBlock, int flowerBlock,
