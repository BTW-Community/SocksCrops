...
public class SCBlockPumpkinGrowingGreenSleeping extends SCBlockPumpkinGrowingGreen {

	protected int awakeFruit;
	
	protected SCBlockPumpkinGrowingGreenSleeping(int iBlockID, int stemBlock, int vineBlock, int flowerBlock, int convertedBlockID, int awakeFruit) {
