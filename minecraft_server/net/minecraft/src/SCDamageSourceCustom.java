...
public class SCDamageSourceCustom extends DamageSource
{
...
//    public static DamageSource m_DamageSourceGloom = new FCDamageSourceCustom( "fcGloom", "was consumed by the darkness" ).setDamageBypassesArmor();	
	...
	public static DamageSource damageSourceCoconut = new SCDamageSourceCustom( "scCoconut", "was knocked out by a falling coconut" );	
	
	String m_sDeathMessage;
	
    protected SCDamageSourceCustom( String sName, String sDeathMessage )
    {
    	super( sName );
