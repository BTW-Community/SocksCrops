...
public class SCBlockAppleSapling extends BlockFlower
{
    ...
    public static final String[] m_sBaseTextureNames = new String[] {"SCBlockAppleSapling_"};

    protected SCBlockAppleSapling(int var1)
    {
        super(var1);
        float var2 = 0.4F;
        ...
        this.SetBuoyant();
        this.setUnlocalizedName("SCBlockAppleSapling");
    ...
    */
    ...
    public void updateTick(World var1, int var2, int var3, int var4, Random var5)
    {
        ...
        if (var1.provider.dimensionId != 1 && var1.getBlockId(var2, var3, var4) == this.blockID && var1.getBlockLightValue(var2, var3 + 1, var4) >= 9 && var5.nextFloat() <= 0.9F) //was 64 chance
        {
    ...
    public void growTree(World var1, int var2, int var3, int var4, Random var5)
    {
        ...
        var7 = SCUtilsTrees.generateApple(var1, var5, var2, var3, var4);
    }
