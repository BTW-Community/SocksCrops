// FCMOD, edited by SC ADDON

package net.minecraft.src;

import java.util.List;

public class SCItemStumpRemover extends FCItemStumpRemover
{
    public SCItemStumpRemover( int iItemID )
    {
    	super( iItemID );
    	...
    	setUnlocalizedName( "SCItemStumpRemover" );
