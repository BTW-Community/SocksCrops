...
public class SCBlockMelonCanaryGrowingSleeping extends SCBlockMelonCanaryGrowing {
	
	protected int awakeFruit;
	
	protected SCBlockMelonCanaryGrowingSleeping(int iBlockID, int stemBlock, int vineBlock, int flowerBlock,
