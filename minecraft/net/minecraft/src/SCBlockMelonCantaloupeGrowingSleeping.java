...
public class SCBlockMelonCantaloupeGrowingSleeping extends SCBlockMelonCantaloupeGrowing {

	protected int awakeFruit;
	
	protected SCBlockMelonCantaloupeGrowingSleeping(int iBlockID, int stemBlock, int vineBlock, int flowerBlock,
