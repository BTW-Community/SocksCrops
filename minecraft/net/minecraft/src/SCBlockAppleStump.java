...
public class SCBlockAppleStump extends Block {
	
	public SCBlockAppleStump(int id) {
        ...
        this.setUnlocalizedName("SCBlockAppleStump");
	}
	...
	public void registerIcons(IconRegister register) {
		sideIcon = register.registerIcon("fcBlockTrunkOak");
		topIcon = register.registerIcon("fcBlockTrunkTop");
	}
}