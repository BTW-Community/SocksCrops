...
public abstract class SCBlockFruitTreesLeavesBase extends FCBlockLeaves {
    ...
    {
        return this.leafIcons[par2 & 3];
    }
    
    public void registerIcons(IconRegister register)
    {
        for (int i = 0; i < leafTextures.length; ++i)
        {
        	 this.leafIcons[i] = register.registerIcon(leafTextures[i]);
        }
    }
	...
	public boolean RenderBlock( RenderBlocks renderer, int i, int j, int k )
	{
    	...
    	renderer.setOverrideBlockTexture(leafIcons[type]);
    ...
    public void RenderBlockAsItem(RenderBlocks renderer, int itemDamage, float fBrightness) {
    	...
    	renderer.setOverrideBlockTexture(leafIcons[itemDamage & 3]);
