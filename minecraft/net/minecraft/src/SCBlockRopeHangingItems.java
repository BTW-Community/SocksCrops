...
public class SCBlockRopeHangingItems extends SCBlockFenceRope implements ITileEntityProvider {

	public SCBlockRopeHangingItems(int iBlockID) {
        super(iBlockID);
		...
		if (heldStack == null)
		{
			...
			if (te != null && te instanceof SCTileEntityRopeHangingItems)
			{
				...
				if (!world.isRemote && storageStack != null) {
					...
					FCUtilsItem.EjectStackAroundBlock(world, i, j, k, storageStack.copy());
					
					rope.setStorageStack(null);
				}
				
				world.setBlockAndMetadata(i, j, k, SCDefs.fenceRope.blockID, world.getBlockMetadata(i, j, k));
				return true;
			}
		}
	...
	public TileEntity createNewTileEntity(World var1) {
		...
		return new SCTileEntityRopeHangingItems();
	}
