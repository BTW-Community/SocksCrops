...
public class SCBlockFarmlandNutrition2Hay extends SCBlockFarmlandNutrition2 {

	protected SCBlockFarmlandNutrition2Hay(int iBlockID) {
		super(iBlockID);
...
//			        		world.setBlockAndMetadataWithNotify( i, j + 1, k, Block.tallGrass.blockID, 1 );
	...
	public void NotifyOfPlantAboveRemoved( World world, int i, int j, int k, Block plantBlock )
	{
    	...
    	if ( world.getBlockId( i, j + 1, k ) != Block.tallGrass.blockID )
    	{
    		world.setBlockAndMetadataWithNotify( i, j, k, 
    				SCDefs.dirtLooseNutrition.blockID, 2);
    	}
	}
    ...
    public void registerIcons( IconRegister register )
    {
		...
		overlayDry = register.registerIcon("SCBlockFarmlandCuttingsOverlay_dry");
		overlayWet = register.registerIcon("SCBlockFarmlandCuttingsOverlay_wet");
    }
	...
	public void RenderBlockAsItem(RenderBlocks renderBlocks, int iItemDamage, float fBrightness) {
		...
		FCClientUtilsRender.RenderInvBlockWithTexture(renderBlocks, this, -0.5F, -0.5F, -0.5F, overlayDry);
	}
