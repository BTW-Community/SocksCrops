...
public abstract class BiomeGenBase
{
    ...
    // SCADDON: Changed
    public static final BiomeGenBase river = (new SCBiomeGenRiver(7)).setColor(255).setBiomeName("River").setMinMaxHeight(-0.5F, 0.0F);
    ...
    // SCADDON: Changed
    public static final BiomeGenBase frozenRiver = (new SCBiomeGenRiverFrozen(11)).setColor(10526975).setBiomeName("FrozenRiver").setEnableSnow().setMinMaxHeight(-0.5F, 0.0F).setTemperatureRainfall(0.0F, 0.5F);
    ...
    // SCADDON: Added
    public static final BiomeGenBase riverDesert = (new SCBiomeGenRiverDesert(23)).setColor(255).setBiomeName("SCRiverDesert").setMinMaxHeight(-0.5F, 0.0F);
    public static final BiomeGenBase riverForest = (new SCBiomeGenRiverForest(24)).setColor(255).setBiomeName("SCRiverForest").setMinMaxHeight(-0.5F, 0.0F);
    public static final BiomeGenBase riverTaiga = (new SCBiomeGenRiverTaiga(25)).setColor(255).setBiomeName("SCRiverTaiga").setMinMaxHeight(-0.5F, 0.0F);
    public static final BiomeGenBase riverExtremeHills = (new SCBiomeGenRiverExtremeHills(26)).setColor(255).setBiomeName("SCRiverExtremeHills").setMinMaxHeight(-0.5F, 0.0F);
    public static final BiomeGenBase riverJungle = (new SCBiomeGenRiverJungle(27)).setColor(255).setBiomeName("SCRiverJungle").setMinMaxHeight(-0.5F, 0.0F);
    public static final BiomeGenBase riverSwamp = (new SCBiomeGenRiverSwamp(28)).setColor(255).setBiomeName("SCRiverSwamp").setMinMaxHeight(-0.5F, 0.0F);
    public static final BiomeGenBase riverPlains = (new SCBiomeGenRiverPlains(29)).setColor(255).setBiomeName("SCRiverPlains").setMinMaxHeight(-0.5F, 0.0F);
