...
public class SCWorldGenRocks2 extends WorldGenerator
{
	...
	public static boolean isMountainBiome(BiomeGenBase biome) {
...
//		desertBiome.add(BiomeGenBase.desert);
	...
	static {
		validBiome.add(BiomeGenBase.riverExtremeHills);	
        ...
        for (int var6 = 0; var6 < 64; ++var6)
        {
            	...
            	rock.canPlaceBlockAt(par1World, var7, var8, var9))
            {
            	...
            	{            		 
            		...
            		else if (isMountainBiome(currentBiome) && var8 < 75)
            		{
            			rock = SCDefs.rocks;  
            			par1World.setBlock(var7, var8, var9, rock.blockID, type, 2);
            		}
