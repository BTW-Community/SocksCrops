...
public class SCWorldGenPalmTreeSmall extends WorldGenerator {
	...
	public SCWorldGenPalmTreeSmall(boolean par1, boolean spawnCocoa) {
		this(par1, 6, 3, 3, false, spawnCocoa);
	}

	public SCWorldGenPalmTreeSmall(boolean par1, int par2, int par3, int par4, boolean par5, boolean spawnCocoa)
	{
		super(par1);
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		return generatePalmTree(world, rand, x,y,z);
	}

	private boolean generatePalmTree(World world, Random rand, int x, int y, int z) {
