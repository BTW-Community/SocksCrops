...
public class SCBlockPumpkinGreenFresh extends SCBlockPumpkinBase {

	protected int stemBlock;
	protected int vineBlock;
	protected int flowerBlock;
	
	protected SCBlockPumpkinGreenFresh(int iBlockID, int stemBlock, int vineBlock, int flowerBlock) {
...
//    private Icon[] connectorIcon;
    ...
    public void registerIcons( IconRegister register )
    {
        ...
        {
            m_iconArray[iTempIndex] = register.registerIcon( "SCBlockPumpkinGreenSide_" + iTempIndex );
        }
        ...
        for ( int iTempIndex = 0; iTempIndex < m_iconArray.length; iTempIndex++ )
        {
            m_iconTopArray[iTempIndex] = register.registerIcon( "SCBlockPumpkinGreenTop_" + iTempIndex );
        }
	...
	protected void setBlockOnFinishedFalling(EntityFallingSand entity, int i, int j, int k)	{
		...
		entity.worldObj.setBlockAndMetadata(i, j, k, SCDefs.pumpkinHarvested.blockID, 0 + 4);
	}
