...
//        par3List.add(new ItemStack(par1, 1, 3));
    ...
    public void RenderBlockAsItem(RenderBlocks renderer, int itemDamage, float fBrightness) {
    	...
    	super.RenderBlockAsItem(renderer, itemDamage, fBrightness);
        	
    	if (getGrowthStage(itemDamage) == 0)
    	{
    		FCClientUtilsRender.RenderInvBlockWithTexture(renderer, this, -0.5F, -0.5F, -0.5F, flower);    	
