...
//				else tileEntity.setLabel(false);
	...
	{			
		String contains = StatCollector.translateToLocal( "SCItemBlockSeedJar.contains" );
		String empty = StatCollector.translateToLocal( "SCItemBlockSeedJar.empty" );
		String hasLabel = StatCollector.translateToLocal( "SCItemBlockSeedJar.hasLabel" );
