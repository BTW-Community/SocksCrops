...
public class SCItemPie extends SCItemFood {
	...
	public SCItemPie(int iItemID, int iHungerHealed, float fSaturationModifier, boolean bWolfMeat,
	...
	int iOldBlockID = world.getBlockId( i, j, k );
	    	...
	    	world.canPlaceEntityOnSide( iNewBlockID, targetPos.i, targetPos.j, targetPos.k, false, iFacing, player, itemStack ) )
	    {
	    	...
	    	int iNewMetadata = m_iBlockMetadata; //getMetadata( itemStack.getItemDamage() );
