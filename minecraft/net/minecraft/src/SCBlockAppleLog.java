...
public class SCBlockAppleLog extends Block {
	
	public SCBlockAppleLog(int id) {
		...
		this.setUnlocalizedName("tree_side");
		this.setCreativeTab(CreativeTabs.tabBlock);
	}

    public int GetFurnaceBurnTime(int var1)
    {
        return GetFurnaceBurnTimeByWoodType(5) * 4;
    }
	...
	public boolean ConvertBlock(ItemStack var1, World var2, int var3, int var4, int var5, int var6)
	{
		...
		var2.setBlockAndMetadataWithNotify(var3, var4, var5,this.blockID, var10); //
	...
	//CLIENT ONLY
	public static String[] topTextures = {"tree_top", "SCBlockAppleLogStripped_top", "SCBlockAppleLog_side", "SCBlockAppleLogStripped_side"};
	public static String[] sideTextures = {"tree_side", "SCBlockAppleLogStripped_side", "SCBlockAppleLog_side", "SCBlockAppleLogStripped_side"};
