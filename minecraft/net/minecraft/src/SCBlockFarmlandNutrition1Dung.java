...
public class SCBlockFarmlandNutrition1Dung extends SCBlockFarmlandNutrition1 {
	...
	protected SCBlockFarmlandNutrition1Dung(int iBlockID) {
		super(iBlockID);
		setUnlocalizedName("SCBlockFarmlandDung_2");
	}
    ...
    public void registerIcons( IconRegister register )
    {
        ...
        m_iconTopWet = register.registerIcon( "SCBlockFarmlandDungWet_2" );
        m_iconTopDry = register.registerIcon( "SCBlockFarmlandDungDry_2" );
    }
