...
public class SCBlockStrawBale extends Block
{
	private String name;
	
	public SCBlockStrawBale(int id, String name)
	{
...
//CLIENT ONLY
	...
	{
		blockIcon = r.registerIcon("SCBlockStrawBale_side");
		topIcon = r.registerIcon("SCBlockStrawBale_top");
	}
