...
public class SCModelCustomCake extends ModelBase {
	...
	*/
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if (f == Item.cake.itemID)
		{
			cake.render(f5);
		}
		else if (f == SCDefs.chocolateCakeItem.itemID)
		{
			chocolate.render(f5);
		}
		else if (f == SCDefs.carrotCakeItem.itemID)
		{
			carrot.render(f5);
		}
	}
