...
public class SCBlockPumpkinGrowingOrangeSleeping extends SCBlockPumpkinGrowingOrange {

	protected int awakeFruit;
	
	protected SCBlockPumpkinGrowingOrangeSleeping(int iBlockID, int stemBlock, int vineBlock, int flowerBlock, int convertedBlockID, int awakeFruit) {
