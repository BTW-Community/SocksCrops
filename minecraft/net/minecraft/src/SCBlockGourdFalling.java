...
public abstract class SCBlockGourdFalling extends FCBlockFalling
{
	...
	abstract protected int ItemCountToDropOnExplode(World world, int i, int k, int j);
    ...
    private void Explode( World world, double posX, double posY, double posZ )
    {
    	...
    	if ( itemToDrop != null )
    	{
	        for (int iTempCount = 0; iTempCount < ItemCountToDropOnExplode(world, (int)posX, (int)posY, (int)posZ); iTempCount++)
	        {
