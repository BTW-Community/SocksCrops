...
public class SCBlockMelonHarvested extends SCBlockGourdHarvested {
	...
	@Override
  	public void registerIcons( IconRegister register )
  	{
		...
		{
  			waterIcon[iTempIndex] = register.registerIcon( "SCBlockMelonWaterSide_" + iTempIndex );
		}
		...
		{
		waterIconTop[iTempIndex] = register.registerIcon( "SCBlockMelonWaterTop_" + iTempIndex );
		}
