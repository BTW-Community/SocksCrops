...
public class SCUtilsTrees {
	...
	public static boolean generateApple(World var0, Random var1, int var2, int var3, int var4) {
		int var5 = 5;
		int var6 = 0;
		int var7 = 0;
		boolean var8 = false;
				...
				for (int var13 = var2 - var12; var13 <= var2 + var12 && var10; ++var13)
				{
					for (var14 = var4 - var12; var14 <= var4 + var12 && var10; ++var14)
					{
						if (var11 >= 0 && var11 < 256)
						{
							...
							if (!var0.isAirBlock(var13, var11, var14) && var15 != Block.leaves.blockID && var15 != Block.grass.blockID && var15 != Block.dirt.blockID && var15 != Block.wood.blockID && var15 != SCDefs.appleLog.blockID && var15 != SCDefs.appleLeaves.blockID)
							{
								var10 = false;
							}
						}
			...
			else
			{
				...
				if (FCUtilsTrees.CanSaplingGrowOnBlock(var0, var2, var3 - 1, var4) && var3 < 256 - var9 - 1)
				{
					...
					for (var14 = var3 - var12 + var9; var14 <= var3 + var9; ++var14)
					{
						...
						for (var17 = var2 - var16; var17 <= var2 + var16; ++var17)
						{
							...
							for (int var19 = var4 - var16; var19 <= var4 + var16; ++var19)
							{
								...
								{
									var0.setBlockAndMetadataWithNotify(var17, var14, var19, SCDefs.appleLeaves.blockID, var7);
								}
							}
						}
					}
					...
					for (var14 = 0; var14 < var9; ++var14)
					{
						...
						if (var0.isAirBlock(var2, var3 + var14, var4) || var15 == Block.leaves.blockID || var15 == SCDefs.appleLeaves.blockID)
						{
							var0.setBlockAndMetadataWithNotify(var2, var3 + var14, var4, SCDefs.appleLog.blockID, var6);
						}
					}
					...
					if (var9 > 2)
					{
						...
						if (var14 == SCDefs.appleLog.blockID)
						{
							var15 = var0.getBlockMetadata(var2, var3, var4);

							if (var15 == var6)
							{
								var0.setBlock(var2, var3, var4, SCDefs.appleStump.blockID);
							}
						}
					}
