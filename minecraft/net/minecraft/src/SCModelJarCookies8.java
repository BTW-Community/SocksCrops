...
public class SCModelJarCookies8 extends ModelBase {
	...
	private final ModelRenderer cookie8;
	private final ModelRenderer cube_r8;

	public SCModelJarCookies8() {
		textureWidth = 24;
		textureHeight = 16;
		...
		cookie8 = new ModelRenderer(this);
		cookie8.setRotationPoint(0.0F, 15.9F - 24F, 0.0F);
		setRotation(cookie8, 0.0F, -0.7854F, 0.0F);
		

		cube_r8 = new ModelRenderer(this);
		cube_r8.setRotationPoint(0.1768F, -0.9F, -0.8839F);
		cookie8.addChild(cube_r8);
		setRotation(cube_r8, 0.0F, 0.0F, -0.0873F);
		this.cube_r8.setTextureOffset(0, 0).addBox(-2.7545F, 0.3812F, -1.6161F, 5, 1, 5, 0.0F);
	}
